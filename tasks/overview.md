...
finish with packaging and documentation (107), and split the pipeline output by
discipline (108) — out of scope for now; was originally scoped as an owner-priority
amendment (`001b`) directly after task 001, moved out to 108 since it's not currently
needed.
